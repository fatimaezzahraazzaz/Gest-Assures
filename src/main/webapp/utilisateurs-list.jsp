            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <a href="utilisateurs?action=new" class="btn btn-primary mb-3">Ajouter un Utilisateur</a>
                                ...
                                <tbody>
                                     <c:forEach var="utilisateur" items="${listUtilisateurs}">
							            <tr>
							                ...
							                <td>${utilisateur.numeroSecSoc}</td>
							                <td>${utilisateur.username}</td>
							                <td>${utilisateur.role}</td>
							                <td>
                                                <a href="utilisateurs?action=edit&id=${utilisateur.id}" title="Modifier" class="btn btn-sm btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="utilisateurs?action=delete&id=${utilisateur.id}" title="Supprimer" class="btn btn-sm btn-danger">
